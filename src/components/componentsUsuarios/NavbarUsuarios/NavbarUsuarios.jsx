  ...
  return (
    <nav className={`sidebar ${isExpanded ? 'expanded' : 'collapsed'}`}>
        ...
        <NavItem
          icon={
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              <path d="M6 2h9l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zm8 7h5l-5-5v5zm-8 4h12v2H6v-2zm0 4h12v2H6v-2z"/>
            </svg>
          }
          label="Presupuestos"
          href="/Presupuestos"
      ...
      <div className="sidebar-bottom">
          ...
          <span className="new-chat-label">Asistente financiero</span>
        </a>
        ...
        <div className="user-menu-container" ref={menuRef}>
          ...
          {isUserMenuOpen && isExpanded && (
            <div className="user-dropdown-menu-sidebar">
              <button 
